"""
Django settings for fotu_41257 project.
...
WSGI_APPLICATION = 'fotu_41257.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fotu_41257 API",
    "DESCRIPTION": "API documentation for fotu_41257 App",
    "VERSION": "v1",
}
